...
public class MyBootstrapper extends AbstractBootstrapper {
  ...
  public MyBootstrapper(
      ...
      @Named("che.infra.dummy.installer_endpoint") String myInstallerEndpoint,
    ...
    super(machineName, runtimeIdentity, myOutputEndpoint, myInstallerEndpoint, eventService);
